...
This loads the existing blockchain and exports it to `$.ombre/export/blockchain.raw`

### Import the exported file

`$ ombre-blockchain-import`

This imports blocks from `$.ombre/export/blockchain.raw` (exported using the
